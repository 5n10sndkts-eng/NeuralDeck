...
export const HoloPanel: React.FC<HoloPanelProps> = ({
        ...
        switch (variant) {
            case 'alert':
                return {
                    ...
                    boxShadow: '0 0 30px rgba(255, 0, 60, 0.2), 0 8px 32px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 0, 60, 0.1)',
                    background: 'linear-gradient(135deg, rgba(30, 0, 10, 0.92) 0%, rgba(15, 0, 5, 0.96) 100%)'
                };
            case 'solid':
                return {
                    ...base,
                    border: '1px solid rgba(0, 240, 255, 0.3)',
                    boxShadow: '0 0 25px rgba(0, 240, 255, 0.15), 0 4px 24px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.08)',
            ...
            case 'elevated':
                return {
                    ...
                    boxShadow: '0 8px 40px rgba(0, 0, 0, 0.5), 0 0 40px rgba(0, 240, 255, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.1)',
    ...
    return (
        <motion.div
            ...
            {...props as any}
        >
            {/* Corner Brackets - Cyberpunk HUD Frame - Enhanced */}
            <svg className="absolute top-0 left-0 w-5 h-5 pointer-events-none" viewBox="0 0 20 20">
                <path d="M0 15 L0 0 L15 0" fill="none" stroke="rgba(0, 240, 255, 0.6)" strokeWidth="2" filter="drop-shadow(0 0 3px rgba(0, 240, 255, 0.5))" />
            </svg>
            <svg className="absolute top-0 right-0 w-5 h-5 pointer-events-none" viewBox="0 0 20 20">
                <path d="M5 0 L20 0 L20 15" fill="none" stroke="rgba(0, 240, 255, 0.6)" strokeWidth="2" filter="drop-shadow(0 0 3px rgba(0, 240, 255, 0.5))" />
            </svg>
            <svg className="absolute bottom-0 left-0 w-5 h-5 pointer-events-none" viewBox="0 0 20 20">
                <path d="M0 5 L0 20 L15 20" fill="none" stroke="rgba(188, 19, 254, 0.6)" strokeWidth="2" filter="drop-shadow(0 0 3px rgba(188, 19, 254, 0.5))" />
            </svg>
            <svg className="absolute bottom-0 right-0 w-5 h-5 pointer-events-none" viewBox="0 0 20 20">
                <path d="M5 20 L20 20 L20 5" fill="none" stroke="rgba(188, 19, 254, 0.6)" strokeWidth="2" filter="drop-shadow(0 0 3px rgba(188, 19, 254, 0.5))" />
            </svg>

            {/* Glass Highlight Overlay - Enhanced */}
            <div
            ...
            {/* Subtle Scanline Effect - Enhanced */}
            <div
                className="absolute inset-0 pointer-events-none opacity-[0.04]"
                style={{
                    background: 'repeating-linear-gradient(0deg, transparent 0px, transparent 2px, rgba(0, 240, 255, 0.6) 2px, rgba(0, 240, 255, 0.6) 4px)',
                    borderRadius: 'inherit'
                }}
            />
        </motion.div>
